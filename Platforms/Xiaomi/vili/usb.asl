...
Device (URS0)
{
    ...
    Device (USB0)
    {
        ...
        Name (_CRS, ResourceTemplate ()                                                                                                 // Current Resource Settings
        {
            Interrupt (ResourceConsumer, Level, ActiveHigh, Shared, ,, )        { 0xA5 }                                                // Interrupt
            Interrupt (ResourceConsumer, Level, ActiveHigh, SharedAndWake, ,, ) { 0xA2 }                                                // Interrupt
            Interrupt (ResourceConsumer, Level, ActiveHigh, SharedAndWake, ,, ) { 0x211 }                                               // Interrupt
