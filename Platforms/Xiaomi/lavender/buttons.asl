    ...
    Method (_CRS, 0x0, NotSerialized)
     {
         ...
         {
           // Power
            GpioInt (Edge, ActiveBoth, ExclusiveAndWake, PullDown, 0x0000, "\\_SB.PM01", , ) { 0 }

            // Vol up
            GpioInt (Edge, ActiveBoth, Exclusive, PullUp, 0x0000, "\\_SB.PM01", , ) { 133 }

            // Vol down
            GpioInt (Edge, ActiveBoth, Exclusive, PullDown, 0x0000, "\\_SB.PM01", , ) { 1 }
        })
        Return (RBUF)
     }
